        ...
        public static bool Check()
        {
            Task.Factory.StartNew(() =>
            {
                try
                {
                    ...
                    string OnlineVersion = new WebClient().DownloadString("https://raw.githubusercontent.com/Zierk59/EloBuddy-Addons-WIP/master/ReCORE/ReCORE/Properties/AssemblyInfo.cs");
