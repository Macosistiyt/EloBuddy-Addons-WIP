...
namespace ReCORE.ReCore.Config
{
    public static class Summoners
    {
        ...
        static Summoners()
        {
            ...
            #region Smite
            if (Managers.SummnerManager.PlayerHasSmite)
            {
            ...
            #endregion
            #region Ignite
            if (Managers.SummnerManager.PlayerHasIgnite)
            {
            ...
            #endregion
            #region Exhaust
            if (Managers.SummnerManager.PlayerHasExhaust)
            {
            ...
            #endregion
            #region Heal
            if (Managers.SummnerManager.PlayerHasHeal)
            {
            ...
            #endregion
            #region Barrier
            if (Managers.SummnerManager.PlayerHasBarrier)
            {
            ...
            #endregion
            #region Snowball
            if (Managers.SummnerManager.PlayerHasSnowball)
            {
            ...
            #endregion
            #region Cleanse
            if (Managers.SummnerManager.PlayerHasCleanse)
            {
